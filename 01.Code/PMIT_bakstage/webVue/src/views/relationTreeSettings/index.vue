<template>
    <div class="app-container">
        ...
        <div>
            <el-table
                ref="singleTable" :data="relationShipList" highlight-current-row style="width: 100%">
                <el-table-column type="index" width="80">
                </el-table-column>
                <el-table-column property="product" label="产品线">
                </el-table-column>
                <el-table-column  property="area" label="地域">
                </el-table-column>
                <el-table-column property="name" label="关系树名称">
                </el-table-column>
